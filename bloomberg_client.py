...
class BloombergClient:
    ...
    def _get_live_data(self, cusips: list[str]) -> dict:
        ...
        fields = [
            ...
            "CPN", "PX_LAST", "MATURITY", "NXT_CALL_DT", "WORKOUT_DT", "YAS_WORKOUT_DT",
            "YLD_CNV_MID", "YLD_YTW", "YAS_BOND_YLD", "MUNI_YLD_TO_WORST", "YLD_YTW_MID", "YLD_YTW_BID", "YLD_TO_WORST", 
            "YLD_YTM_MID", "YLD_YTM_BID", "YLD_TO_MATURITY",
            "DUR_ADJ_MID", "MID_MOD_DUR_MTY", "CNVX_MID", 
            "BB_COMPOSITE", "RTG_SP_UNDERLYING", "RTG_MDY_UNDERLYING", "RTG_MDY_LT_UNDL", "RTG_FITCH_UNDERLYING", "RTG_SP_MUNI_LONG_TERM", "RTG_MDY_MUNI_LONG_TERM",
            ...
            "INDUSTRY_SECTOR", "INDUSTRY_SUBGROUP", "ISSUER_INDUSTRY", "STATE_CODE", "MUNI_TAX_PROV", 
            "MUNI_ISSUE_TYP", "MUNI_PURPOSE", "MUNI_SOURCE", "CREDIT_ENHANCEMENTS"
        ]
        for field in fields:
